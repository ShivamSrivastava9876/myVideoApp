...
const getUserPlaylists = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    throw new ApiError(
      500,
      "Getting error in fetching the playlist information."
    );
  }
});
...
const getPlaylistById = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    throw new ApiError(
      500,
      `"Getting error in fetching the response. Error is ${error}"`
    );
  }
});
...
const addVideoToPlaylist = asyncHandler(async (req, res) => {
  ...
  if (!playlistId) {
    throw new ApiError(
      400,
      "Please give playlist ID where you want to add the video."
    );
  }
  ...
  if (!videoId) {
    throw new ApiError(
      400,
      "Please give video ID which you want to add in the playlist."
    );
  }
  ...
  try {
    ...
    if (playList.owner?.toString() !== req.user?._id.toString()) {
      throw new ApiError(
        500,
        "Only playlist owner can add the videos in the playlist."
      );
    }
    ...
    if (!valueExists) {
      ...
      return res
        .status(200)
        .json(new ApiResponse(200, "Video already added in the playlist."));
    }
  } catch (error) {
    throw new ApiError(
      500,
      `"Getting error in adding video to playlist. Error is ${error}"`
    );
  }
});
...
const removeVideoFromPlaylist = asyncHandler(async (req, res) => {
  ...
  if (!playlistId) {
    throw new ApiError(
      400,
      "Please give playlist ID where you want to remove/delete the video."
    );
  }
  ...
  if (!videoId) {
    throw new ApiError(
      400,
      "Please give video ID which you want to remove/delete from the playlist."
    );
  }
  ...
  try {
    ...
    if (valueExists) {
      ...
      return res
        .status(200)
        .json(new ApiResponse(200, "Video is not exist in playlist."));
    }
  } catch (error) {
    throw new ApiError(
      500,
      `"Getting error in removing video to playlist. Error is ${error}"`
    );
  }
});
...
const deletePlaylist = asyncHandler(async (req, res) => {
  ...
  if (!playlistId) {
    throw new ApiError(
      400,
      "Please give playlist ID which you want to delete."
    );
  }
  ...
  try {
    ...
    return res
      .status(200)
      .json(new ApiResponse(200, { deletePlaylist }, "Deleted the playlist."));
  } catch (error) {
    throw new ApiError(
      500,
      `"Getting error in deleting the playlist. Error is ${error}"`
    );
  }
});
...
const updatePlaylist = asyncHandler(async (req, res) => {
  ...
  if (!playlistId) {
    throw new ApiError(
      400,
      "Please give playlist ID which you want to update."
    );
  }
  ...
  try {
    ...
    if (oldPlaylist.owner.equals(userId)) {
      ...
      if (!updatedPlaylist) {
        throw new ApiError(
          500,
          "Error in updating the playlist name or description."
        );
      }
      ...
      return res
        ...
        .json(
          new ApiResponse(
            200,
            updatedPlaylist,
            "Playlist name or description updated successfully."
          )
        );
    } else {
    ...
    throw new ApiError(
      500,
      `"Getting error in updating the playlist name or description. Error is ${error}"`
    );
  }
});
